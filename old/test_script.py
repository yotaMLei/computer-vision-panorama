...
# **********************************************************************************
H, status= cv2.findHomography(match_p_src.T,match_p_dst.T,0)
...
#
# b_img_out = cv2.warpPerspective(img_src, H_ransac, dsize=(1452,1088), flags=1, borderMode=0, borderValue=0)
# print(b_img_out.shape)
# plt.imshow(b_img_out+img_dst)
# plt.show()
